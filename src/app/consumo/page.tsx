            ...
            <main className="flex-1 p-10 overflow-auto">
                <header className="flex justify-between mb-8">
                    ...
                    <div className="flex gap-2">
                        {/* Botão Novo para ir para página de justificativas */}
                        <Link href="/consumo/alertas" className="bg-red-100 hover:bg-red-200 text-red-700 px-4 py-3 rounded-xl font-bold flex gap-2 border border-red-200 items-center">
